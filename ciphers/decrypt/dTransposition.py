...
from util.pyperclip import pyperclip


myMessage = """tntWh seteon tmIa o uarsntoe o,a  u w sos  rd s,uta i  tnoi mo eh oan osuWs j  ushtstei   nwhnta Ilt  eI    c ehwWtoo dssh e Iiioomt sht   o n m,Iteacnn jm -i--is  nhIesmmitI heoier   oesmooere  e a,nu sorWh . tleensm js.tI"
"""
myKey = '302'
mode = 'dencrypt' # set to 'encrypt' or 'decrypt'
